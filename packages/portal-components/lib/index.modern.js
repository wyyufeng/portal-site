...
import React__default, { useRef, useContext, useState, useMemo, useEffect, Component, createContext, createElement, useCallback } from 'react';
import objectFitImages from 'object-fit-images';
import cls from 'classnames';
import { useRoutesMap, NavLink, Link, useLocation, useHistory, useQueryList, useQueryOne, useDataProvider } from '@portal-site/core';
...
var button_base = css(_templateObject());
var list_base = css(_templateObject2());
var pulse = keyframes(_templateObject3());
var skeleton_animation = css(_templateObject4(), pulse);
...
var Picture = function Picture(_ref) {
  ...
  var sourceSets = useMemo(function () {
  ...
  _proto.renderChildren = function renderChildren() {
    ...
    if (loading) {
      return jsx("div", {
        ...
        style: style,
        css: css(_templateObject$1(), skeleton_animation)
      }, this.renderContent());
    }
...
var Card = function Card() {
  ...
  }, jsx(Title, null), jsx(Line, null), jsx(Line, null)));
};
var List = function List() {
  return jsx("div", {
    className: "portal-skeleton-list",
    css: css(_templateObject3$1())
  }, jsx(Avatar, {
    style: {
      width: 48,
      height: 48
...
var Avatar = function Avatar(_ref2) {
  ...
  return jsx("span", {
    ...
    style: style,
    css: css(_templateObject4$1(), shape === 'circle' && 'border-radius:50%')
  });
};
...
var Nav = function Nav(_ref) {
  ...
  var routes = useRoutesMap();
  return jsx("nav", {
    className: "portal-nav",
    css: css(_templateObject$2())
  }, jsx("ul", {
...
var Center = function Center(_ref) {
  ...
  return jsx("div", Object.assign({
    ...
    css: css(_templateObject$3(), width)
  }, rest), children);
};
...
var Header = function Header(_ref) {
  ...
  return jsx("header", {
    ...
    css: css(_templateObject$4())
  }, jsx(Center, {
    css: css(_templateObject2$3())
  }, jsx("div", {
...
var Pager = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, prevLabel)), showLeftMore && createElement("li", {
      className: 'more-page page-btn disable'
    }, createElement("a", null, "...")), this.pagination(), showRightMore && createElement("li", {
      className: 'more-page page-btn disable'
    }, createElement("a", null, "...")), createElement("li", {
    ...
    }, nextLabel)), showLast && createElement("li", {
    ...
    }, lastLabel))), showTotal && createElement("span", {
      className: 'page-total'
    }, "\u603B\u9875\u6570:", pageCount), showJump && createElement("div", {
      className: 'page-jump'
    }, createElement("input", {
      value: jumpPage,
...
var Meta = function Meta(_ref) {
  ...
  return jsx("div", {
    ...
    css: [{
      display: 'flex',
      flex: 1
    }, center && css(_templateObject$5())]
  }, jsx("div", {
    css: css(_templateObject2$4()),
    className: "portal-list-item-meta-avatar"
  }, avatar), jsx("div", {
    className: "portal-list-item-meta-main",
    css: css(_templateObject3$3())
  }, jsx("div", {
    css: css(_templateObject4$2()),
    className: "portal-list-item-meta-header"
  }, jsx("h4", {
    css: css(_templateObject5$1())
  }, title), jsx("span", {
    css: css(_templateObject6$1())
  }, secondary)), jsx("div", {
  ...
  }, description), actions && jsx("div", {
    css: css(_templateObject7()),
...
var Item = function Item(_ref) {
  ...
  return jsx("li", {
    css: css(_templateObject$6()),
    className: "portal-list-item"
  }, children, extra && jsx("div", {
    css: css(_templateObject2$5()),
...
var List$1 = function List(_ref) {
  ...
  var _useQueryList = useQueryList(resource, page, size),
...
var Article = function Article(_ref) {
  ...
  var _useQueryOne = useQueryOne(resource, path),
  ...
  return jsx(Center, {
    ...
    css: css(_templateObject$7())
  }, jsx("h1", {
    css: css(_templateObject2$6())
  }, Title ? jsx(Title, {
    title: title
  }) : title), jsx("section", {
    className: "portal-article-info",
    css: css(_templateObject3$4())
  }, jsx("span", {
    className: "portal-article-info-pubdate"
  }, "\u53D1\u5E03\u65F6\u95F4\uFF1A", Pubdate ? jsx(Pubdate, {
    pubdate: publishDate
  }) : publishDate), jsx("address", {
    className: "portal-article-info-address",
    css: css(_templateObject4$3())
  }, "\u4FE1\u606F\u6765\u6E90\uFF1A", Address ? jsx(Address, {
    address: source
  }) : source), jsx("span", {
    className: "portal-article-info-visitcount"
  }, "\u6D4F\u89C8\u6B21\u6570\uFF1A", VisitCount ? jsx(VisitCount, {
    visitCount: visitCount
  }) : visitCount))), jsx("section", {
    className: "portal-article-content",
    css: css(_templateObject5$2())
  }, Content ? jsx(Content, {
    content: content
  }) : jsx("article", {
...
var Like = function Like(_ref) {
  var resource = _ref.resource,
      ...
      Icon = _ref.icon;
  var likeFetch = useDataProvider('likeIt');
  var unLikeFetch = useDataProvider('unLikeIt');
  var btn = useRef(null);
  ...
  return jsx("button", {
    ...
    css: [button_base, _active && css(_templateObject$8())],
    type: "button"
  }, Icon);
};
Like.defaultProps = {
  icon: jsx(ThumbsUp, null),
  cancellable: false
};
...
var Carousel = function Carousel(_ref) {
  ...
  var _useQueryList = useQueryList(resource, 1, 10, onSuccess),
      records = _useQueryList.records;

  var items = records.map(function (item) {
    return jsx(Picture, {
      key: item.imgSrc,
      className: cls('portal-carousel-slide', css(_templateObject$9())),
      source: item.imgSrc
    });
  });
  return jsx("div", {
    className: "portal-carousel",
    css: css(_templateObject2$7())
  }, jsx("div", {
    className: "portal-carousel-container",
    css: css(_templateObject3$5())
  }, jsx("div", {
    ref: wrapperRef,
...
export { Article, Breadcrumb, Carousel, CarouselLib, Center, ConfigConsumer, ConfigContext, ConfigProvider, Header, Like, List$1 as List, ListView, Nav, index as Pager, Picture, Skeleton };
