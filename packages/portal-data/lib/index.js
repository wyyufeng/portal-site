          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return effects.call([dataProvider, 'queryRoutes'], action.payload);

              case 3:
                records = _context.sent;
                _context.next = 6;
                return effects.put(actions.getRoutesSuccess(records));
              ...
              case 8:
                ...
                _context.next = 12;
                return effects.put(actions.getRoutesFailure(null, null, _context.t0));
        ...
        return regeneratorRuntime.wrap(function _callee$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return effects.takeLatest(actions.getRoutes, worker);
...
exports.getImgFromHtml = getImgFromHtml;
exports.html2text = html2text;
exports.listMapper = listMapper;
exports.listOneMapper = listOneMapper;
exports.routesMap = routeMaps;
