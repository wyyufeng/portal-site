...
export default class Pager extends React.Component<PagerProps, PagerState> {
  ...
  render() {
    ...
    const showRightMore = pageCount > pageRange && current < Math.ceil(pageCount - pageRange / 2);
    const showLeftMore = pageCount > pageRange && current > Math.ceil(pageRange / 2);
    return (
      <div className={containerClassName}>
        ...
        {showJump && (
          <div className="page-jump">
            <input value={jumpPage} onChange={this.onJumpInputChange} type="text" />
